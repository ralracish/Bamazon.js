...
@include b(table) {
  ...
  th, td {
    ...
    &.current-cell{
      .cell{
        background-color: $--table-current-cell-background;
        color: $--color-white;
      }
      &.eas-edit-cell{
        .cell{
  ...
  @include e(fixed-right) {
    ...
    .eas-table__fixed-header-wrapper,
    .eas-table__fixed-body-wrapper,
    .eas-table__fixed-footer-wrapper {
      left: auto;
      right: 0;
    }
  }
